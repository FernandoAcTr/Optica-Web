  ...
  <body>
    ...
    <div class="sidenav">
      <div class="login-main-text">
        <h2>Reestablecer<br>Contraseña</h2>
    ...
    <div class="main">
      ...
      <div class="col-md-6 col-sm-12">
        <div class="login-form">
          <form action="login.php?action=cambiarContra" method="POST">
            ...
            <div class="form-group m-0">
              ...
              <input type="password" class="form-control" placeholder="Repetir contarseña" name="contrasena" id="rep_contrasena">
            </div>
